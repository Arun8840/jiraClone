  ...
  return (
    <div className="bg-indigo-600 rounded-xl relative">
      ...
      <div
       ...
       after:absolute after:size-5 after:-top-5 before:absolute before:size-5 before:-right-5 before:bottom-0 after:bg-radial-[at_50%_75%] from-sky-200 to-red-500"
      ></div>
    </div>
  )
}
