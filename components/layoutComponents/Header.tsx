...
function Header() {
  ...
  return (
    <>
      <nav className="p-1 w-full flex justify-between items-center bg-background/10 backdrop-blur-sm sticky top-0 z-20 font-poppins_normal border-b border-dashed">
        <div>
